...
public class SplitPaneTest {
    ...
    Book[] books = {new Book("java自学宝典", new ImageIcon("swing\\img\\container\\java.png"), "国内关于 Java 编程最全面的图书 \n 看得懂 ， 学得会"),

            new Book("轻量级的JAVAEE企业应用实战", new ImageIcon("swing\\img\\container\\ee.png"), "SSM整合开发的经典图书，值的拥有"),

            new Book("Android基础教程", new ImageIcon("swing\\img\\container\\android.png"), "全面介绍Android平台应用程序\n 开发的各方面知识")
